    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-cream px-4">
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <p className="text-charcoal-light text-center text-sm mb-6">
            Přihlaste se pomocí svého účtu
          </p>

          {error && (
            <div className="mb-6 p-3 bg-coral/10 border border-coral/20 rounded-lg text-coral text-sm text-center">
              {error === "OAuthAccountNotLinked"
                ? "Tento e-mail je již přiřazen k jinému účtu."
                : "Při přihlášení došlo k chybě. Zkuste to prosím znovu."}
            </div>
          )}
